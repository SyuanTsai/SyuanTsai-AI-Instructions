...
- 使用者只要求 Review 時，預設只提供審查結果；已授權的實作任務中處理 PR findings，依 `.github/AI-Rules/DevelopmentWorkflow.md` 主動修正、驗證、回覆證據並完成處置，不把每輪 feedback 視為新的修正授權。 <!-- ai-invariant:code-review.review-only-default -->
