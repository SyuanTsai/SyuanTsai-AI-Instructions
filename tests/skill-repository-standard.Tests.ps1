Describe 'Agent Skill Repository Standard v1 contract' {
    ...
    It 'UnitT20_requires_latest_stable_tools_trusted_sources_and_resolved_identity_evidence' {
        ...
        Assert-Equal $toolchain.tools.skillspector.pythonDistribution.requiresPythonPolicy 'simple-json-wheel-metadata-exact-current-interpreter' 'Simple JSON and wheel METADATA Requires-Python must agree and allow the current interpreter.'
    ...
    It 'UnitT26d_requires_offline_hash_locked_SkillSpector_installation' {
        ...
        Assert-Match $resolver 'requiresPython=simple-json-wheel-metadata-exact-current-interpreter' 'Resolved SkillSpector identity must record Requires-Python cross-verification.'
