...
'@
    ...
    It 'UnitT80_binds_the_PR33_adoption_evidence_job_to_exact_independent_inputs' {
        ...
        foreach ($identity in @(
            ...
            '0becd113c894409b395f908856cc1ad289060850',
            '205a3f1196afbcea6d724d696246531dab386991',
        ...
        Assert-Match $workflow '60320bb696d1ee1498bbe9476698d32d1a5f4508' 'The evidence job must pin the reviewed PR36 validator blob.'
