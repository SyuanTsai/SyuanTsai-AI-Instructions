...
'@
    ...
    It 'UnitT80_binds_the_PR33_adoption_evidence_job_to_exact_independent_inputs' {
        ...
        foreach ($identity in @(
            ...
            '6bb8d33c1588f47cd3f172806cf6818bb868cad3',
            '68807beebc7a68aabac85fdd0959bcfb85a2a6bd',
        ...
        Assert-Match $workflow 'c21aa14721dc7a90e6c29f7e945f0d710876b92a' 'The evidence job must pin the reviewed PR36 validator blob.'
