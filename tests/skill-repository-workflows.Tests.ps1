...
'@
    ...
    It 'UnitT15_runs_linux_callback_containment_before_full_suites_and_authority_gate' {
        ...
        Assert-Equal ([regex]::Matches($required, 'ExpectedTotalCount\s*=\s*611').Count) 2 'Both full-suite shard jobs must include the merged resolver regressions and proposed-exception review tests.'
