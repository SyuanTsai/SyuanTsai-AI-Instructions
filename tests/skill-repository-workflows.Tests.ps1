...
'@
    ...
    It 'UnitT80_binds_the_PR33_adoption_evidence_job_to_exact_independent_inputs' {
        ...
        foreach ($identity in @(
            ...
            'bed281a6cf88146b6736a0d429950329b9c43ab2',
            '5d38d5cdcd6f2d234b314164e4f23b3c2240ab50',
        ...
        Assert-Match $workflow '0d6e8cd0740dfeb05fe7f33c6bb0283c01c5991c' 'The evidence job must pin the reviewed PR36 validator blob.'
