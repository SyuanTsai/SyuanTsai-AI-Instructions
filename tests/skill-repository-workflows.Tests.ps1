...
'@
    ...
    It 'UnitT15_runs_linux_callback_containment_before_full_suites_and_authority_gate' {
        ...
        Assert-Equal ([regex]::Matches($required, 'ExpectedTotalCount\s*=\s*619').Count) 2 'Both full-suite shard jobs must include the protected source merge adoption tests.'
