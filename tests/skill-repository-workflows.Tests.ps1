...
'@
    ...
    It 'UnitT80_binds_the_PR33_adoption_evidence_job_to_exact_independent_inputs' {
        ...
        foreach ($identity in @(
            ...
            '5cb8d03d90e155c17081c8e0600164e4fb65de8d',
            'e3c014e516370eca28adab713e5f47f0c0951021',
        ...
        Assert-Match $workflow 'e428c9ebf21a0e45da6adcaa4f2815d6c02a31bd' 'The evidence job must pin the reviewed PR36 validator blob.'
