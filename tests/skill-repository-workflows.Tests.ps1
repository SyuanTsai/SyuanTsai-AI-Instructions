...
'@
    ...
    It 'UnitT80_binds_the_PR33_adoption_evidence_job_to_exact_independent_inputs' {
        ...
        foreach ($identity in @(
            ...
            'e38ad67f2491b3473bdcd914fe4ffebc1de8cf58',
            '66094392ea67b648b344098dc1947172bfe67b9f',
        ...
        Assert-Match $workflow 'a6397c938ced6878f268783e2197771922e4caec' 'The evidence job must pin the reviewed PR36 validator blob.'
