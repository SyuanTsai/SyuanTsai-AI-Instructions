...
- When production code or tests are involved, load `.codex/AI-Rules/Testing.en.md`. Focus the review on the correctness, risks, and necessary coverage of the final code and tests; treat the TDD sequence only as implementation guidance.
