...
- Performing or resuming development work, handling PR feedback, synchronizing ticket progress, or using development validation tools → `.codex/AI-Rules/DevelopmentWorkflow.en.md` <!-- ai-route:{"module":"development-workflow","triggers":["development-task","pull-request-follow-up","ticket-progress-sync","development-toolchain-use"]} -->
