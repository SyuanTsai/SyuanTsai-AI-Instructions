...
4. Reject path traversal, absolute/out-of-root paths, dot/colon/non-portable segments, reparse/special files, duplicate JSON keys, duplicate identities, unknown destructive ownership and mutable source selectors.
